...
class ConfigureAccountMessageSchema(_ValidateMixin, Schema):  # type: ignore
...
class RejectedConfigMessageSchema(_ValidateMixin, Schema):  # type: ignore
...
class AccountUpdateMessageSchema(_ValidateMixin, Schema):  # type: ignore
...
class AccountPurgeMessageSchema(_ValidateMixin, Schema):  # type: ignore
